...
export function sendTracingMetricsToAgent(tracingMetrics: import('@instana/core/src/tracing').TracingMetrics, cb: (...args: any) => any): void;
export function reportUncaughtExceptionToAgentSync(eventData: any, spans: Array<InstanaBaseSpan>): void;
export function isConnected(): boolean;
export type InstanaBaseSpan = import('@instana/core/src/tracing/cls').InstanaBaseSpan;
/**
