...
function RegisterRoutes(app) {
  ...
  app.get(
    ...
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController.prototype.authError),
    async function UsersController_authError(request, response, next) {
      const args = {};
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
      let validatedArgs = [];
      try {
  ...
  app.get(
    ...
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController.prototype.getUser),
    async function UsersController_getUser(request, response, next) {
      const args = {
  ...
  app.post(
    ...
    authenticateMiddleware([{ xxx: [] }]),
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController.prototype.createUser),
    async function UsersController_createUser(request, response, next) {
      const args = {
  ...
  app.post(
    ...
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController),
    ...(0, runtime_1.fetchMiddlewares)(usersController_1.UsersController.prototype.createUsers),
    async function UsersController_createUsers(request, response, next) {
      const args = {
        requestBody: { in: 'body', name: 'requestBody', required: true, ref: 'UserCreationParams' }
      };
      // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
