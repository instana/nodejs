...
module.exports = function (name, version, isLatest, mode) {
  ...
  it(`must not associate unrelated HTTP calls with long query span (mode: ${mode})`, () => {
    setTimeout(() => {
      controls.sendRequest({
        method: 'GET',
        path: '/quick-query'
  ...
  it(`must not associate unrelated non-traced calls with long query span (mode: ${mode})`, () => {
    setTimeout(() => {
