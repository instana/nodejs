...
const usePromises = driverModeEnvVar === 'mysql2/promises';
const mysql2 = usePromises ? require('mysql2/promise') : require('mysql2');
...
const app = express();
const logPrefix = `Express / MySQL2 App (${process.pid}):\t`;
