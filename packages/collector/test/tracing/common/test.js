...
function registerTests(withMinimalDelay) {
  const controls = new Controls({
    agentControls,
    minimalDelay: withMinimalDelay ? 6000 : undefined
  });
  ...
  it(`must respect delay (with minimal delay: ${withMinimalDelay})`, () =>
    controls
      ...
      .then(withMinimalDelay ? () => verifyMinimalDelay(agentControls) : () => verifyNoMinimalDelay(agentControls)));
}
