...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/api/users/auth-error',
            ...
            async function UsersController_authError(request: ExRequest, response: ExResponse, next: any) {
        ...
        app.post('/api/users/error/:anyId',
            ...
            async function UsersController_createUsers(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"UserCreationParams"},
            };
