...
// - v1.9.0 is the latest verified release.
['v190', 'v130'].forEach(version => {
  mochaSuiteFn(`OpenTelemetry instrumentations using @opentelemetry/api ${version}`, function () {
  ...
  // add new tests here
  describe.skip('with different otel-api version installed on app', function () {
    globalAgent.setUpCleanUpHooks();
    const agentControls = globalAgent.instance;
