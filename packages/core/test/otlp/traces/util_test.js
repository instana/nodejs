  ...
  describe('isLogSpan', () => {
    ...
    describe('edge cases', () => {
      it('should return false for null span', () => {
        expect(isLogSpan(null)).to.be.false;
      });

      it('should return false for undefined span', () => {
        expect(isLogSpan(undefined)).to.be.false;
      });

      it('should return false for empty object', () => {
        expect(isLogSpan({})).to.be.false;
      });

      it('should return false for span with only trace and span IDs', () => {
        const span = {
          t: '123',
          s: '456'
        };
      ...
      it('should return false for span with empty data object', () => {
        const span = {
          t: '123',
          s: '456',
          data: {}
      ...
      it('should return false for span with null data', () => {
        const span = {
          t: '123',
          s: '456',
          data: null
      ...
      it('should return false for span with name as non-string', () => {
        const span = {
          t: '123',
          s: '456',
          n: 123
      ...
      it('should return false for span with empty string name', () => {
        const span = {
          t: '123',
          s: '456',
          n: ''
