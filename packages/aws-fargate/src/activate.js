...
function init() {
  ...
  // The instanaCore.preInit call makes sure the tracing instrumentations can monkey-patch the modules we instrument,
  // before the application under monitoring can access them via require.
  // Initializing the instrumentations/monkey-patching needs to happen synchronously,
  // directly at startup inorder to init the tracer automatically when that package is loaded.
  instanaCore.preInit();
