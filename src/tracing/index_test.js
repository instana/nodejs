...
describe('tracing', function() {
  describe('supportsAsyncWrap', function() {
    it('must support various Node.js versions', function() {
      ...
      expect(tracing.supportsAsyncWrap('7.3.3')).to.equal(true);
    });
    ...
    it('must report various Node.js versions as not supported', function() {
      ...
      expect(tracing.supportsAsyncWrap('8.0.0')).to.equal(false);
      expect(tracing.supportsAsyncWrap('8.3.0')).to.equal(false);
    });
  });
});
