...
module.exports = exports = function(isCallbackApi) {
  var wrapper = isCallbackApi ? cls.ns.runAndReturn.bind(cls.ns) : cls.ns.runPromise.bind(cls.ns);
  ...
  function startExitSpan(name, tags, callback) {
    ...
    return startSdkSpan(name, constants.EXIT, constants.SDK.EXIT, exports.startExitSpan, tags, null, null, callback);
  }
  ...
  function init() {
    // The SDK has no need for an init function, this only exists to keep a homogeneous among all modules that can be
